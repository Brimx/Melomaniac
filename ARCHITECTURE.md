# Melomaniac v4.5.0 — Arquitectura
...
La versión de trabajo se mantiene en la serie `4.5.0`; el número minor/parche exacto se fijará al cerrar este ciclo de cambios.
