# Melomaniac v4.5.1 — Arquitectura
...
La versión de trabajo se mantiene en la serie `4.5.1`; el número minor/parche exacto se fijará al cerrar este ciclo de cambios.
