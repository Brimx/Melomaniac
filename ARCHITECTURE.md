# Melomaniac v4.1.0 — Arquitectura
...
La versión de trabajo se mantiene en la serie `4.1.0`; el número minor/parche exacto se fijará al cerrar este ciclo de cambios.
