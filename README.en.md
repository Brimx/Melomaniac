...
The working version belongs to the `4.2.0` series: major version 4 is retained while the latest functional changes and fixes are consolidated before the next minor/patch number is fixed.
