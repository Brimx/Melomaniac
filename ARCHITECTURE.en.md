# Melomaniac v4.4.2 — Architecture
...
The working version remains in the `4.4.2` series; the exact minor/patch number will be fixed when this change cycle is closed.
