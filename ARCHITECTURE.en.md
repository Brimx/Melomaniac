# Melomaniac v4.5.1 — Architecture
...
The working version remains in the `4.5.1` series; the exact minor/patch number will be fixed when this change cycle is closed.
