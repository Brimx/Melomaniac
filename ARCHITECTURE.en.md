# Melomaniac v4.1.0 — Architecture
...
The working version remains in the `4.1.0` series; the exact minor/patch number will be fixed when this change cycle is closed.
