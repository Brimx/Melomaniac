# Melomaniac v4.2.0 — Architecture
...
The working version remains in the `4.2.0` series; the exact minor/patch number will be fixed when this change cycle is closed.
